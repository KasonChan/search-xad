...
class ArgumentsTest extends FlatSpec with MustMatchers with Util {
  "isValidArguments(Array(\"source\")) " must "= Some(ValidArguments(\"source\"))" in {
    isValidArguments(Array("source")) must be(Some(ValidArguments("source")))
  }

  "isValidArguments(Array(\"helloWorld\")) " must "= Some(ValidArguments(\"helloWorld\"))" in {
    isValidArguments(Array("helloWorld")) must be(Some(ValidArguments("helloWorld")))
  }
  ...
  "isValidArguments(Array(\"source\", \"-h\", \"5\")) " must "= Some(ValidArguments(\"source\", 5))" in {
    isValidArguments(Array("source", "-h", "5")) must be(Some(ValidArguments("source", 5)))
  }
  ...
  "isValidArguments(Array(\"-h\", \"120\", \"source\")) " must "= Some(ValidArguments(\"source\", 120))" in {
    isValidArguments(Array("-h", "120", "source")) must be(Some(ValidArguments("source", 120)))
  }
